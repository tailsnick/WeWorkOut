...
namespace WeWorkOut.Data
{
    public class DBInitializer
    {
        public static void Initialize(DB context)
        {
            ...
            var goals = new Goal[]
            {
                new Goal{UserID="1", Exercise = running, MeasurementType="Time", MeasurementQuantity=20, Completed=false, Deadline=new DateTime(2019, 12, 25)},
                new Goal{UserID="1", Exercise = running, MeasurementType="Time", MeasurementQuantity=2,  Completed=false, Deadline=new DateTime(2020,  1,  1)},
                ...
                new Goal{UserID="1", Exercise = pushups, MeasurementType="Time", MeasurementQuantity=50, Completed=false, Deadline=new DateTime(2019, 11,  3)}
            };
